...
class PutSerializer(serializers.Serializer):
    ...
    description = serializers.CharField(required=False,allow_null=True,max_length=700)
    end_date = serializers.CharField(required=False,allow_null=True)
    hours = serializers.CharField(required=False,max_length=50)
    salary = serializers.CharField(required=False,max_length=50)
    user_id = serializers.IntegerField(write_only=True,required=False)
    system_role = serializers.CharField(write_only=True,required=False)
    company_id = serializers.IntegerField(write_only=True,required=False)
