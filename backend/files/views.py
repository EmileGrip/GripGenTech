...
class FilesApi(APIView):
    ...
    def __handle(self,request):
        ...
        if request.method == 'POST':
            serializer = PostSerializer(data=request.query_params, context={'query_params': request.query_params,'request': request, 'method': request.method})
        ...
        if request.method == 'DELETE':
            serializer = DeleteSerializer(data=request.query_params, context={'query_params': request.query_params,'request': request, 'method': request.method})
